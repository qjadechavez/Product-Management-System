...
public class DeleteProductForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Delete Product Form");
    ...
    int confirm = JOptionPane.showConfirmDialog(this, "Are you sure you want to remove the product?", "Confirm Delete", JOptionPane.YES_NO_OPTION);
    ...
    try {
        ...
        String selectedRecord = (String) jComboBox1.getSelectedItem();

        if (selectedCategory.equals("LOCAL")) {
            String deleteQuery = "DELETE FROM LOCAL WHERE ID = ?";
            PreparedStatement deleteStatement = connection.prepareStatement(deleteQuery);
            deleteStatement.setString(1, selectedRecord);
            int rowsAffected = deleteStatement.executeUpdate();
            deleteStatement.close();
            if (rowsAffected > 0) {
                System.out.println("Record deleted successfully from LOCAL.");
            } else {
                System.out.println("Record not found in LOCAL.");
            }
        } else if (selectedCategory.equals("IMPORT")) {
            String deleteQuery = "DELETE FROM IMPORTED WHERE ID = ?";
            PreparedStatement deleteStatement = connection.prepareStatement(deleteQuery);
            deleteStatement.setString(1, selectedRecord);
            int rowsAffected = deleteStatement.executeUpdate();
            deleteStatement.close();
            if (rowsAffected > 0) {
                System.out.println("Record deleted successfully from IMPORTED.");
            } else {
                System.out.println("Record not found in IMPORTED.");
            }
        } else {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (model.getRowCount() > 0) {
            int selectedRowIndex = 0; // You can change this to get the desired row index
